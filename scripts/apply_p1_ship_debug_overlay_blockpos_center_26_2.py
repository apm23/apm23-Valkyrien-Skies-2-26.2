...
# Mechanical packed-key vocabulary for exactly six MixinClientChunkCache ship-chunk map sites.
# Preserve storage, packet, connectivity, relight, renderer, and unload lifecycle authority.
clientchunk_pack_helper = Path(__file__).with_name("apply_p1_clientchunkcache_chunkpos_pack_26_2.py")
...
print("P1_CLIENTCHUNKCACHE_CHUNKPOS_PACK_26_2_CHAINED_HEIGHTMAPS_SECTION_RANGE_V1")
