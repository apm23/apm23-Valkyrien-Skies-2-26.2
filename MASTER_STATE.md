...
- all frozen ClientLevel, ClientPacketListener, ClientChunkCache, LevelChunk, vanilla LevelRenderer, and ViewArea vocabulary units listed above retain original VS2 authority/order.
